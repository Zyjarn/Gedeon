...
@Service
public class PropertyTemplateDAOImpl extends OpenECMDAO implements ClassDefinitionDAO{
	
	private OEFactoryImpl factory;
	
	@Autowired
	public PropertyTemplateDAOImpl(OEDBConnector dbConnect,OEFactoryImpl factory) {
		super(dbConnect);
	}
