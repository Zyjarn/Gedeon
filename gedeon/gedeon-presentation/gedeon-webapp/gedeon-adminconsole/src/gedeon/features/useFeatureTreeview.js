...
import Selector1 from '../widget/treeselectors/Selector1';

import './Treeview.css';

export function useFeatureTreeview(props) {
			...
			"children": [
				{
					...
					"children": [
						...
						},
						{
							...
							"children": [
								{
									"label":"Child1.2.1 adzad azdzadzad azdza dzazadzd",
									"value": "child1.2.1",
								},
								{
									"label":"Child1.2.2",
									...
									"children": [
										...
										{
											"label":"Child1.2.2.2 dzadz azdza",
											"value": "child1.2.2.2",
										}
									]
								}
				...
				<div className="h flex">
					<div className="treeview-selector">
						<div className="selector-holder hcolumn">
							<div className="treeselector bordered">
								<Selector1/>
							</div>
...
export default useFeatureTreeview;
